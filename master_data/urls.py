...
urlpatterns = [ 
    ...
    url(r'^api/master/search_project$', views.search_project),
    url(r'^api/master/search_customer$', views.search_customer),
    url(r'^api/master/search_part$', views.search_part),
    url(r'^api/master/search_package$', views.search_package),
    url(r'^api/master/search_truck$', views.search_truck),
    url(r'^api/master/search_driver$', views.search_driver),
