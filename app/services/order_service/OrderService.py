...
class OrderService:
    ...
    def search_miss_match (self,customer_code,project_code,supplier_code,plant_code,start_date,end_date):
 
        cursor = connection.cursor()
        cursor.execute(" Begin;  SELECT * FROM search_miss_match(%s,%s,%s,%s,%s,%s);",[customer_code,project_code,supplier_code,plant_code,start_date,end_date]  )
