...
class TruckPlanManagementService:
    ...
    def search_generate_truck_plan(self,customer_code,project_code,due_date):
        ...
        # query_first = query_first + joint_str_first + where_str_first + 
        # " GROUP BY truck_plan_management_truckplan.truckplan_no,truck_plan_management_pickup.due_date,
        # truck_plan_management_pickup.route_code,
        # truck_plan_management_pickup.route_trip  "

        # query_second = query_second + joint_str_second + where_str_second + 
        # " GROUP BY truck_plan_management_pickup.truckplan_no,
        # truck_plan_management_pickup.due_date,
        # truck_plan_management_pickup.route_code,
        # truck_plan_management_pickup.route_trip "
